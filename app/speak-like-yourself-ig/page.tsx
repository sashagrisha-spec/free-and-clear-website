...
import CheckoutForm from '../speak-like-yourself/CheckoutForm'

export const metadata: Metadata = {
  title: 'Speak Like Yourself | סדנת תקשורת חיה באנגלית',
  description: 'סדנת תקשורת חיה באנגלית. שעה וחצי בזום.',
  robots: {
    index: false,
    follow: false,
  },
...
export default function SpeakLikeYourselfIGPage() {
  return (
    <>
      <Nav />
      ...
      <section style={{ backgroundColor: 'var(--navy)' }} className="pt-32 pb-20 px-6" dir="rtl">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg mb-3" style={{ color: 'rgba(255,255,255,0.55)' }}>
            מחיר מיוחד לעוקבים בלבד
          </p>
          <p className="text-base font-semibold mb-10" style={{ color: 'var(--yellow)' }}>
            יום שני, 29 ביוני · 20:00 שעון ישראל · זום
          </p>
          <div className="flex items-center justify-center gap-3 mb-6">
            <span className="text-xl line-through" style={{ color: 'rgba(255,255,255,0.35)' }}>189 ₪</span>
            <span className="text-3xl font-bold" style={{ color: 'var(--yellow)' }}>147 ₪</span>
          </div>
          <CheckoutForm variant="followers" />
          <p className="mt-4 text-sm" style={{ color: 'rgba(255,255,255,0.35)' }}>
            שעה וחצי · מחיר מיוחד לעוקבים בלבד
          </p>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: 'var(--navy)' }} className="py-20 px-6" dir="rtl">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            <span className="text-lg line-through" style={{ color: 'rgba(255,255,255,0.35)' }}>189 ₪</span>
            <span className="text-2xl font-bold" style={{ color: 'var(--yellow)' }}>147 ₪</span>
          </div>
          <CheckoutForm variant="followers" />
        </div>
      </section>
