...
export const keywordTargets = [
  { q: 'איך להתכונן למצגת באנגלית', lang: 'he', note: 'לא איך להציג אלא איך מתכוננים (יש כבר פוסט על ההצגה עצמה, זה נושא אחר): מתאמנים בראש ולא בקול רם, כותבים טקסט כתוב ומנסים להגיד משהו אחר, לא מחליפים מילים קשות במילים קלות, מתעלמים מהחלקים הקשים ומקווים שלא ישימו לב. בעברית אפשר לאלתר, באנגלית אין רשת.' },
